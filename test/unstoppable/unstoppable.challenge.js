...
describe("[Challenge] Unstoppable", function () {
  ...
  it("Execution", async function () {
    ...
    // Taking advantage of the "flashLoan()" function in the UnstoppableVault contract
    // if (convertToShares(totalSupply) != balanceBefore) revert InvalidBalance(); // enforce ERC4626 requirement
    // "totalSupply is only updated when the "deposit" function is called from the ERC4626 contract"
    // So we simply by sending some tokens to the vault contract, therefore making the "balanceBefore" variable different from the "totalSupply" variable
